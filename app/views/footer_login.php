<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
		...
		<div class="copyright"> 2017 © Estrategas Digitales. </div>
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>js/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
            ...
            <!-- spinner-->
            <script src="<?php echo base_url(); ?>js/assets/global/plugins/ladda/spin.min.js" type="text/javascript"></script>
            <script src="<?php echo base_url(); ?>js/assets/global/plugins/ladda/ladda.min.js" type="text/javascript"></script>
