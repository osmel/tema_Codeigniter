...
<?php $this->load->view( 'header' , $datos ); ?>
            ...
            <!-- Comienzo del contenedor -->
                        ...
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Nuevo perfil de usuario | Cuenta
                            <small>Pagina de cuenta de usuario</small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
                            ...
                            <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
                                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                    ...
                                    <ul class="media-list list-items">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo base_url(); ?>js/assets/layouts/layout3/img/avatar2.jpg" alt="...">
                                            <div class="media-body">
