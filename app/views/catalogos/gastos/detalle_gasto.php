	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-4 col-md-3 marginbuttom">
				<a href="<?php echo base_url(); ?>nuevo_gasto" type="button" class="btn btn-success btn-block">Nueva categoría</a>
			</div>
		</div>
		<br>
		...
		<div class="panel panel-primary">
			...
			<div class="col-md-12">
				...
				<div class="table-responsive">
					...
					<section>
						<table id="tabla_cat_gastos" class="display table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
