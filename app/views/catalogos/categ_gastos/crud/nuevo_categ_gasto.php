	    ...
	    <!--Contenido de la pagina -->
	        <div class="page-content-wrapper">
	        	<div class="page-content">
						...
						<?php //$this->load->view( 'catalogos/categ_gastos/detalle_categ_gasto'); ?>
			...
			<?php 
			    ...
			    $funcion ="validar_nuevo_categ_gasto";
			...
			<div class="" style="background-categ_gasto:transparent !important">
					<br>	
				
				<div class="col-md-10 col-md-offset-1 row" style="background-categ_gasto:transparent !important">
